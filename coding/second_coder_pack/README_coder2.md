# Second-coder pack v3.1 — brainsci-4583950
...
Order of work
1. Read codebook_v2.md (v2.1, frozen; verify its hash: `sed '$d' codebook_v2.md | shasum -a 256` (macOS) or `head -n -1 codebook_v2.md | sha256sum` (GNU) must equal the value in codebook_v2.sha256).
