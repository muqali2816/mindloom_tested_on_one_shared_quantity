...
Blindness, stated plainly: the second author read the submitted manuscript, including its condensed 72-cell Table 1 with the legacy codes. Blindness is therefore partial for the 72 `submitted-v1` cells and full for the 48 cells added in revision; agreement is reported for the two subsets separately. Nothing in this pack carries a first-coder decision on any cell, row or pair.
